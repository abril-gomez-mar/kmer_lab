...
Aprendí: Puedo usar una cadena de texto que combine espacios en blanco (los caracteres ajenos al kmer en uso) y repeticiones del símbolo '^'. Por consiguiente, puedo declarar una variable, *linea*, que sea un string conformado por la suma de dos multiplicaciones: ' ' * i (los caracteres no pertenicientes al kmer actualizado) y '^' * k (denota la cantidad de nucleótidos englobados por el kmer). Entonces, puedo ocupar esta línea de código:
